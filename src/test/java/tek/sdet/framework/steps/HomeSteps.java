...
public class HomeSteps extends CommonUtility {
	...
	public void userIsOnRetailWebsite() {
		...
		String actualTitle = getTitle(); // wrote this one in CommonUtility Assert.assertEquals(expectedTitle,
											// actualTitle);
...
//  @When("User click on All section")//  public void userClickOnAllSection() {//      click(factory.homePAge().allElement);//      logger.info("user clicked on All element");//  }    @Then("User verifies {string} is present")
