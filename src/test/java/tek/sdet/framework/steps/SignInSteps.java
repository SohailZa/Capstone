...
public class SignInSteps extends CommonUtility {
	...
	public void userEditInformationWithBelowData(DataTable dataTable) {
		...
		// clearTextUsingSendKeys(factory.signInPage().cardNumberInput); WebElement
		// cardNumberInput = (factory.signInPage().cardNumberInput);
		...
		// sendText(factory.signInPage().nameOnCardInput,
		// paymentInformation.get(0).get("nameOnCard"));
		slowDown();
		...
		// sendText(factory.signInPage().nameOnCardInput,
		// paymentInformation.get(0).get("securityCode"));
	...
	public void UserfillUpatedinformationbelow(DataTable editAddress) {
		...
		click(factory.signInPage().countryDropDown);
		slowDown();
//        sendText(factory.signInPage().nameontheaddress,Addaddress.get(0).get("country"));//        slowDown();        clearTextUsingSendKeys(factory.signInPage().nameontheaddress);
